...
add_action( 'init', 'wpwt_register_sign_up_post_type' );
...
function wpwt_register_sign_up_post_type() {

	$labels = array(
		'name'                  => _x( 'Sign Ups', 'Post Type General Name', 'wordpress-wedding-theme' ),
		'singular_name'         => _x( 'Sign Up', 'Post Type Singular Name', 'wordpress-wedding-theme' ),
		'menu_name'             => __( 'Sign Ups', 'wordpress-wedding-theme' ),
		'name_admin_bar'        => __( 'Sign Up', 'wordpress-wedding-theme' ),
		'archives'              => __( 'Item Archives', 'wordpress-wedding-theme' ),
		'attributes'            => __( 'Item Attributes', 'wordpress-wedding-theme' ),
		'parent_item_colon'     => __( 'Parent Item:', 'wordpress-wedding-theme' ),
		'all_items'             => __( 'All Items', 'wordpress-wedding-theme' ),
	...
	$args = array(
		'label'                 => __( 'Sign Up', 'wordpress-wedding-theme' ),
		'labels'                => $labels,
	...
	register_post_type( 'wpwt_sign_up', $args );
}
